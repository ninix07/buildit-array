...
namespace barray
{
	...
	struct barray_expr_add : public barray_expr<T>
	{
		...
		barray_expr_add(const struct barray_expr<T> &expr1, const struct barray_expr<T> &expr2) : expr1(expr1), expr2(expr2)
		{
	...
	struct barray_expr_mul : public barray_expr<T>
	{
		...
		barray_expr_mul(const struct barray_expr<T> &expr1, const struct barray_expr<T> &expr2) : expr1(expr1), expr2(expr2)
		{
			computed_sizes = match_expr_sizes(expr1.get_expr_size(), expr2.get_expr_size());
		}
	...
	struct barray_expr_cross : public barray_expr<T>
	{
		...
		barray_expr_cross(const struct barray_expr<T> &expr1, const struct barray_expr<T> &expr2) : expr1(expr1), expr2(expr2)
		{
